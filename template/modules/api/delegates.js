 ...
 * @param {Delegates~getDelegateCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Delegates~getDelegatesCallback} cb - Callback handles response from Acme.
 */
 ...
 *
 * @param {Delegates~getFeeCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Delegates~getForgedByAccount} cb - Callback handles response from Acme.
 */
 ...
 * @param error - Error of api call execution.
 * @param response - Response of api call execution.
 * @param response.fees - Amount of Acme that delegate forged.
 */
 ...
 * @param {Delegates~addDelegate} cb - Callback handles response from Acme.
 */
