 ...
 * @param {Transactions~getTransactionsCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Transactions~getTransaction} cb - Callback handles response from Acme.
 */
 ...
 * @param {Transactions~getUnconfirmedTransaction} cb - Callback handles response from Acme.
 */
 ...
 * @param {Transactions~getUnconfirmedTransactions} cb - Callback handles response from Acme.
 */
 ...
 * @param {Transactions~addTransactionsCallback} cb - Callback handles response from Acme.
 */
