...
/**
 * Open account in Acme.
 *
 * @param secret - Secret of account.
 * @param {Accounts~openCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Accounts~balanceCallback} cb - Callback handle response from Acme.
 */
 ...
 * @param address - Address of account.
 * @param {Accounts~publicKeyCallback} cb - Callback handle response from Acme.
 */
 ...
 *
 * @param address - Address of account.
 * @param {Accounts~delegatesCallback} cb - Callback handle response from Acme.
 */
