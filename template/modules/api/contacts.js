 ...
 * @param {Contacts~getContactsCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Contacts~addContactCallback} cb - Callback handles response from Acme
 */
 ...
 * @param {Contacts~getFeeCallback} cb - Callback handles response from Acme.
 */
