 ...
 * @param {Multisignatures~pendingCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Multisignatures~signCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Multisignatures~addCallback} cb - Callback handles response from Acme.
 */
