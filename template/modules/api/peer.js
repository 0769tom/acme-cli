 ...
 * @param {Peer~getPeersCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Peer~getPeerCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Peer~versionCallback} cb - Callback handles response from Acme.
 */
