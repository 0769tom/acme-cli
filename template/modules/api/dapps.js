 ...
 * @param {Dapps~getGenesisCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Dapps~sendWithdrawal} cb - Callback handles response from Acme.
 */
 ...
 * @param cb - Callback handles response from Acme.
 */
 ...
 * @param {Dapps~setReadyCallback} cb - Callback handles response from Acme.
 */
