 ...
 * @param {Sql~selectCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Sql~insertCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Sql~batchCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Sql~updateCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Sql~removeCallback} cb - Callback handles response from Acme.
 */
