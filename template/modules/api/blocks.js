 ...
 *
 * @param id - Block id.
 * @param {Blocks~blockCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Blocks~getBlocksCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Blocks~getHeightCallback} cb - Callback handles response from Acme.
 */
 ...
 * @param {Blocks~getFeeCallback} cb - Callback handles response from Acme.
 */
